...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng marker1 = new LatLng(52.2958115,76.9397645); // Памятник С. Торайгырову
    static final LatLng marker2 = new LatLng(52.2969105,76.9415669); // 2 поликлиника
    static final LatLng marker3 = new LatLng(52.2960543,76.9406335); // FORA
  ...
  //      mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.toraighyrov)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.almazmedical)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.fora)).alpha(ALPHA).
